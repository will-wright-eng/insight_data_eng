...
def save_config(today, new_dir, filename_inputcsv, bucket, filename_outputparquet, n):
...
def main():
    ...
    try:
        ...
        save_config(today, new_dir, filename_inputcsv, bucket, filename_outputparquet, n)
    finally:
